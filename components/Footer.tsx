...
export const DiscordIcon = (props: React.ComponentPropsWithoutRef<'svg'>) => {
  return (
    <svg viewBox="0 0 20 20" aria-hidden="true" {...props}>
...
export const SocialLink = ({
  ...
  return (
    <Link href={href} target="_blank" rel="noreferrer" className="group">
      ...
      <Icon className="h-6 w-6 fill-zinc-700 transition-all  group-hover:scale-125" />
    </Link>
  )
}
...
const MinimalSocialsFooter = () => {
  return (
    <div className='w-full border-t border-gray-900/40   text-gray-600 bg-white'>
    <div className="flex max-w-[85rem] w-full mx-auto flex-col items-center justify-between gap-5  pt-8 sm:flex-row mb-12 ">
      <p className="text-xs">
